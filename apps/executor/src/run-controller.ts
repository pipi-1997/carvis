        ...
        while (true) {
          ...
          if (shouldFlush) {
            ...
            const flushHandle = await input.bridge.startRun({
              ...
              requestedSandboxMode: run.requestedSandboxMode,
              resolvedSandboxMode: run.resolvedSandboxMode,
              sandboxModeSource: run.sandboxModeSource,
            ...
            if (event.eventType === "run.completed") {
              ...
              if (session && resolvedBridgeSessionId && !resetAfterRunCreated) {
                await input.repositories.conversationSessionBindings.saveBindingContinuation({
                  ...
                  sandboxMode: run.resolvedSandboxMode,
                  workspace: run.workspace,
