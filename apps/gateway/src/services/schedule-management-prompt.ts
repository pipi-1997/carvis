  ...
  return {
    build(input: {
      ...
      return [
        ...
        "If the user wants to create, list, update, disable, enable, or otherwise manage schedules or reminders, use the local carvis-schedule CLI.",
        ...
        "Available commands: carvis-schedule create, carvis-schedule list, carvis-schedule update, carvis-schedule disable, carvis-schedule enable.",
